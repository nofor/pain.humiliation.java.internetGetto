...
public class Task4 {
    ...
    public void runMethod(String[] inputMassive, int indexForDelete) {
        outputMassive(inputMassive);
        outputReverseMassive(inputMassive);
        deleteIndex(inputMassive, indexForDelete);
    }
    ...
    private void deleteIndex(String[] inputMassive, int indexForDelete) {
        String outputSentence = "";

        for (int i = 0; i < inputMassive.length; i++) {
            if (i == indexForDelete) inputMassive[i] = "_";
